		...
		<div class="content">
			<div class="leftbox">
				...
				<div class="contentBox">
					...
					<form action="<%=basePath%>department/insertstation" method="post">
						<table class="sysTable">
						<tr>
								<td class="sTitle"><span class="important">*</span>设置二级管理员:</td>
								<td colspan="3">
								     <select id="userlist1" name="department_manager">
								...
								<tr>
									...
									<td colspan="3"><select id="citylist" name="city_name">
										<option value="-1">请选择</option>
											<c:forEach var="ci" items="${citylist}">
												<option value='<c:out value="${ci.city_id }" />'>
													${ci.city_name }</option>
											</c:forEach>
									</select> <select id="arealist" name="district_name">
											<option value="-1">请选择</option>
											
									</select> <select id="streetlist" name="street_name">
											<option value="-1">请选择</option>
									</select></td>
								</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="station_manager" /></td>
							</tr>
							<tr>
								<td class="sTitle">联系方式1-座机:</td>
								<td colspan="3"><input type="text" name="station_tel" /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>地址:</td>
								<td colspan="3"><input type="text" style="width: 490px;" name="station_address" /></td>
							</tr>
							<tr class="sSubmit">

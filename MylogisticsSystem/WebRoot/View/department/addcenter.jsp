		...
		<div class="content">
			<div class="leftbox">
				...
				<div class="contentBox">
					...
					<form action="<%=basePath%>department/insertData" method="post">
						<table class="sysTable">
							<tr>
								...
								<select id="arealist" name="district_name">
								<option value="-1">请选择</option>
							...
							<tr>
								...
								<td colspan="3"><input type="text" name="department_name" style="width: 400px;" /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>设置二级管理员:</td>
								<td colspan="3">
								     <select id="userlist" name="manager_id">
							...
							<tr>
								...
								<td><input type="text" name="department_manager" /></td>
							</tr>
							<tr>
								<td class="sTitle">联系方式1-座机:</td>
								<td colspan="3"><input type="text" name="department_tel" /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>联系方式2-手机:</td>
								<td colspan="3"><input type="text" name="department_mobile"  /></td>
							</tr>
							<tr>
								<td class="sTitle"><span class="important">*</span>地址:</td>
								<td colspan="3"><input type="text" style="width: 490px;" name="department_address" /></td>
							</tr>
							<tr class="sSubmit">
